...
import { WatchCard } from '../storefront/components/WatchCard'
import { getWishlistWatch, getWishlistWatchId } from './commerceUtils'
...
export const WishlistPage = () => {
  ...
  return (
    <main>
      ...
      {isLoading ? (
        <div className="rounded-lg border border-emerald-100 bg-emerald-50 px-3.5 py-3 font-bold text-emerald-950">Loading wishlist...</div>
      ) : wishlist.length === 0 ? (
