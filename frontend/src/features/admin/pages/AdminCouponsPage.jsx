          ...
          <div className="flex max-h-[92vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl bg-white border border-slate-200/80 shadow-[0_24px_50px_-12px_rgba(15,23,42,0.25)] animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between border-b border-slate-100 px-6 py-5 bg-slate-50/50">
              ...
              <button 
                ...
                disabled={isSaving}
                className="grid h-8 w-8 cursor-pointer place-items-center rounded-lg border border-slate-200 bg-white text-primary hover:text-primary hover:bg-slate-100 transition-colors disabled:cursor-not-allowed disabled:opacity-60"
              ...
              <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                ...
                <label className="mt-2 flex w-fit cursor-pointer select-none items-center gap-3 text-xs font-semibold uppercase tracking-wider text-primary">
                  <input 
                    ...
                    type="checkbox" 
                    className="h-4.5 w-4.5 rounded-lg border-slate-300 text-accent focus:ring-accent/20 transition-colors"
...
const inputClass = 'w-full min-w-0 rounded-xl border border-slate-200/80 bg-white px-3.5 py-2.5 text-primary placeholder:text-primary outline-none text-sm transition-all focus:border-accent focus:ring-4 focus:ring-accent/20'
