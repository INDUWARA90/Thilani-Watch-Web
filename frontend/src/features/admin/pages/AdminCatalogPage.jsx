...
export const AdminCatalogPage = () => (
  <div className="mx-auto max-w-7xl space-y-8 p-4 sm:p-6 lg:p-8">
    ...
    <div className="flex flex-col gap-1 pb-2">
      <div className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-primary/45">
        <Settings2 className="h-4.5 w-4.5 text-primary/45" />
