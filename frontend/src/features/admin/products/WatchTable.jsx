        ...
        <table className="w-full min-w-[800px] border-collapse text-left">
          <thead>
            <tr className="border-b border-slate-100 bg-slate-50/70">
              ...
              <th className="p-4 text-xs font-bold uppercase tracking-wider text-primary">Inventory Status</th>
              <th className="p-4 text-xs font-bold uppercase tracking-wider text-primary">Visibility</th>
