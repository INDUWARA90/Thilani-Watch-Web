        ...
        <table className="w-full min-w-[800px] border-collapse text-left">
          <thead>
            <tr className="border-b border-slate-100 bg-slate-50/70">
              <th className="p-4 text-xs font-bold uppercase tracking-wider text-primary/60">Watch Details</th>
              <th className="p-4 text-xs font-bold uppercase tracking-wider text-primary/60">Brand</th>
              <th className="p-4 text-xs font-bold uppercase tracking-wider text-primary/60">Category</th>
              <th className="p-4 text-xs font-bold uppercase tracking-wider text-primary/60">Inventory Status</th>
              <th className="p-4 text-xs font-bold uppercase tracking-wider text-primary/60">Visibility</th>
            ...
            {watches.map((watch) => {
              ...
              return (
                <tr key={getId(watch)} className="group transition-colors hover:bg-slate-50/50">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="relative flex h-11 w-11 shrink-0 overflow-hidden rounded-xl border border-slate-100 bg-slate-50">
                        {imageSrc ? (
                          ...
                          <Package className="m-auto h-5 w-5 text-primary/45" />
                        )}
                      </div>
                      <div className="min-w-0">
                        <strong className="block max-w-[18rem] whitespace-normal break-words text-sm font-bold leading-snug text-primary">
                          {watch.name}
                        </strong>
                  ...
                  {/* Brand */}
                  <td className="p-4 text-sm font-medium text-primary/75">
                    ...
                    <div className="flex items-center gap-2.5">
                      <input
                        className={`max-w-[76px] rounded-xl border px-2.5 py-1.5 text-center text-sm font-semibold outline-none transition-all focus:ring-4 ${isOutOfStock
                            ...
                            : 'border-slate-200 bg-white text-primary focus:border-teal-500 focus:ring-teal-500/10'
                          }`}
                    ...
                    <div className="flex justify-end gap-1">
                      ...
                      <button
                        className={`inline-flex h-8 w-8 cursor-pointer items-center justify-center rounded-lg border transition-all active:scale-95 ${watch.isPublished
                            ? 'border-slate-200 bg-white text-primary/45 hover:text-amber-600 hover:border-amber-100 hover:bg-amber-50/30'
                            : 'border-slate-200 bg-white text-primary/45 hover:text-emerald-600 hover:border-emerald-100 hover:bg-emerald-50/30'
                          }`}
