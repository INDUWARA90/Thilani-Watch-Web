...
export const AdminOrdersPage = () => {
  ...
  return (
    <div className="grid gap-5 rounded-lg border border-slate-200 bg-white p-6 shadow-[0_18px_60px_rgba(28,41,56,0.06)] sm:p-7">
      ...
      {isLoading ? <div className="rounded-lg border border-emerald-100 bg-emerald-50 px-3.5 py-3 font-bold text-emerald-950">Loading orders...</div> : <OrdersTable orders={orders} />}
    </div>
  )
}
...
export const AdminOrderDetailPage = () => {
  ...
  if (isLoading) return <div className="rounded-lg border border-emerald-100 bg-emerald-50 px-3.5 py-3 font-bold text-emerald-950">Loading order...</div>
