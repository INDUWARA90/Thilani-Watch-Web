...
export const AboutBrandSection = () => (
  <section className="rounded-lg border border-white/12 bg-surface p-6 shadow-glowSm sm:p-8">
    <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_420px] lg:items-center">
      <div className="min-w-0">
        <div className="mb-6 flex items-center gap-4">
          ...
          <div>
            <p className="font-heading text-3xl font-bold text-white">Thilani</p>
            <p className="text-lg font-semibold text-white/70">Watch Center</p>
          </div>
        </div>
        <h2 className="max-w-2xl font-heading text-3xl font-bold leading-tight text-white sm:text-4xl">A local watch store experience built for confident online buying.</h2>
      ...
      <div className="w-full max-w-md rounded-lg border border-white/12 bg-black/25 p-5 lg:max-w-none">
        <div className="rounded-lg border border-white/10 bg-white/[0.04] p-6 text-center shadow-sm">
