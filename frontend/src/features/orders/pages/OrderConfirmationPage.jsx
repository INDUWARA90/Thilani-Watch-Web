...
export const OrderConfirmationPage = () => {
  ...
  return (
    <main className="min-h-[calc(100vh-120px)] bg-base px-4 py-12 text-primary sm:px-6 sm:py-16 lg:px-10 lg:py-20">
      <section className="mx-auto grid max-w-[1100px] gap-8 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-start">
        <div className="overflow-hidden rounded-lg border border-primary/10 bg-card shadow-premiumSm">
          <div className="relative overflow-hidden bg-base px-6 py-10 text-primary sm:px-10 sm:py-12">
            <div className="absolute bottom-4 left-1/2 h-px w-[80%] -translate-x-1/2 bg-white/70 shadow-premium" />
          ...
          <div className="grid gap-5 p-6 sm:p-8">
            <div className="grid gap-4 rounded-lg border border-primary/10 bg-black/25 p-5 sm:grid-cols-3">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <Link
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-white px-6 text-sm font-bold text-black no-underline shadow-lg transition hover:shadow-premium active:scale-[0.98]"
                to={`/orders/${orderId}`}
              >
                View order
              ...
              <Link
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-primary/10 bg-card px-6 text-sm font-bold text-primary no-underline transition hover:border-primary/10 hover:shadow-premiumSm active:scale-[0.98]"
                to="/orders"
              >
                My orders
              </Link>
        ...
        <aside className="rounded-lg border border-primary/10 bg-card p-6 shadow-premiumSm">
          <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-lg bg-primary/5 text-primary">
            <ShoppingBag className="h-7 w-7" aria-hidden="true" />
          </div>
          <h2 className="font-heading text-xl font-bold text-primary">What happens next</h2>
          ...
          <Link
            className="mt-6 inline-flex min-h-11 w-full items-center justify-center rounded-full bg-white px-5 text-sm font-bold text-black no-underline transition hover:shadow-premium active:scale-[0.98]"
            to="/watches"
          >
            Continue shopping
          </Link>
