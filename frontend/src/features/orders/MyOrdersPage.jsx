...
import { canCancelOrder, formatDate, formatOrderMoney, getOrderId, getOrderStatus, getOrderTotal, getPaymentStatus, normalizeOrders } from './orderUtils'
...
export const MyOrdersPage = () => {
  ...
  return (
    <main>
      ...
      {isLoading ? (
        <div className="rounded-lg border border-emerald-100 bg-emerald-50 px-3.5 py-3 font-bold text-emerald-950">Loading orders...</div>
      ) : orders.length === 0 ? (
